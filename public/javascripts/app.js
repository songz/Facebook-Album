...
(function() {
  var PictureFile, dragEnter, dragLeave, drop, getAlbums, navTop, numEnter, prevent, reset, temp, tmpStepMessage,
  ...
  drop = function(evt) {
    var file, fileId, files, formData, html, i, newDiv, picture, url, xhr, _i, _j, _len, _len1, _results, _results1;
